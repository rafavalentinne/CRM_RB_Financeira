...
def main() -> None:
    ...
    try:
        ...
        print(f"Erro ao conectar ao MongoDB: {e}"); return
    ...
    consulta_conv = ConversationHandler(
    ...
    add_msg_conv = ConversationHandler(
